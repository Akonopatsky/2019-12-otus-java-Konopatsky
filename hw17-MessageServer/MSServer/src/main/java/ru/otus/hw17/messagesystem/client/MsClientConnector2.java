...
public class MsClientConnector2 implements MsClient{
    private static final Logger logger = LoggerFactory.getLogger(MsClientConnector2.class);
    private final SocketClient socketClient;
    private final String name;
    private final HandlersStore handlersStore;
    private final CallbackRegistry callbackRegistry;

    public MsClientConnector2(String name, SocketClient socketClient, HandlersStore handlersStore, CallbackRegistry callbackRegistry) {
    ...
    public boolean equals(Object o) {
        ...
        MsClientConnector2 msClient = (MsClientConnector2) o;
