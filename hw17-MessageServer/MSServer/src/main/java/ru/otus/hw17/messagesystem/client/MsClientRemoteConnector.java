...
public class MsClientRemoteConnector implements MsClient{
    private static final Logger logger = LoggerFactory.getLogger(MsClientRemoteConnector.class);
    private final SocketClient socketClient;
    private final String name;
    private final HandlersStore handlersStore;
    private final CallbackRegistry callbackRegistry;

    public MsClientRemoteConnector(String name, SocketClient socketClient, HandlersStore handlersStore, CallbackRegistry callbackRegistry) {
    ...
    public boolean equals(Object o) {
        ...
        MsClientRemoteConnector msClient = (MsClientRemoteConnector) o;
